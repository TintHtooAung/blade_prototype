...
(function() {
    ...
    <ul class="sidebar-nav" style="margin-top: 0;">
        ...
        <li>
            <a href="/staff/dashboard" class="<?php echo $activePage === 'dashboard' ? 'active' : ''; ?>" title="Staff Dashboard">
                <i class="fas fa-home"></i> <span class="sidebar-nav-label">Staff Dashboard</span>
            </a>
        </li>
        <li>
            <a href="/staff/announcements" class="<?php echo $activePage === 'announcements' ? 'active' : ''; ?>" title="Announcements">
                <i class="fas fa-bell"></i> <span class="sidebar-nav-label">Announcements</span>
            </a>
        </li>
        <li>
            <a href="/staff/event-planner" class="<?php echo $activePage === 'event-planner' ? 'active' : ''; ?>" title="Event Planner">
                <i class="fas fa-calendar"></i> <span class="sidebar-nav-label">Event Planner</span>
            </a>
        </li>
        <li>
            <a href="/staff/event-calendar" class="<?php echo $activePage === 'event-calendar' ? 'active' : ''; ?>" title="Event Calendar">
                <i class="fas fa-calendar-alt"></i> <span class="sidebar-nav-label">Event Calendar</span>
            </a>
        </li>
        <li>
            <a href="/staff/schedule-planner" class="<?php echo $activePage === 'schedule-planner' ? 'active' : ''; ?>" title="Schedule Planner">
                <i class="fas fa-clock"></i> <span class="sidebar-nav-label">Schedule Planner</span>
            </a>
        </li>
        <li class="sidebar-section-header" style="margin: 1rem 0; color: #a0aec0; font-size: 0.75rem; text-transform: uppercase; padding: 0 1.5rem;">ACADEMIC</li>
        <li>
            <a href="/staff/attendance" class="<?php echo $activePage === 'attendance' ? 'active' : ''; ?>" title="Attendance">
                <i class="fas fa-user-check"></i> <span class="sidebar-nav-label">Attendance</span>
            </a>
        </li>
        <li>
            <a href="/staff/collect-attendance" class="<?php echo $activePage === 'collect-attendance' ? 'active' : ''; ?>" title="Collect Attendance">
                <i class="fas fa-clipboard-check"></i> <span class="sidebar-nav-label">Collect Attendance</span>
            </a>
        </li>
        <li>
            <a href="/staff/teacher-profiles" class="<?php echo $activePage === 'teacher-profiles' ? 'active' : ''; ?>" title="Teacher Profiles">
                <i class="fas fa-chalkboard-teacher"></i> <span class="sidebar-nav-label">Teacher Profiles</span>
            </a>
        </li>
        <li>
            <a href="/staff/student-profiles" class="<?php echo $activePage === 'student-profiles' ? 'active' : ''; ?>" title="Student Profiles">
                <i class="fas fa-user-graduate"></i> <span class="sidebar-nav-label">Student Profiles</span>
            </a>
        </li>
        <li>
            <a href="/staff/academic-management" class="<?php echo $activePage === 'academic-management' ? 'active' : ''; ?>" title="Academic Management">
                <i class="fas fa-graduation-cap"></i> <span class="sidebar-nav-label">Academic Management</span>
            </a>
        </li>
        <li>
            <a href="/staff/exam-database" class="<?php echo $activePage === 'exam-database' ? 'active' : ''; ?>" title="Exam Database">
                <i class="fas fa-clipboard-list"></i> <span class="sidebar-nav-label">Exam Database</span>
            </a>
        </li>
        <li class="sidebar-section-header" style="margin: 1rem 0; color: #a0aec0; font-size: 0.75rem; text-transform: uppercase; padding: 0 1.5rem;">FINANCE</li>
        <li>
            <a href="/staff/student-fee-management" class="<?php echo $activePage === 'student-fee-management' ? 'active' : ''; ?>" title="Student Fee">
                <i class="fas fa-file-invoice-dollar"></i> <span class="sidebar-nav-label">Student Fee</span>
            </a>
        </li>
        <li>
            <a href="/staff/salary-payroll" class="<?php echo $activePage === 'salary-payroll' ? 'active' : ''; ?>" title="Salary & Payroll">
                <i class="fas fa-money-check-alt"></i> <span class="sidebar-nav-label">Salary & Payroll</span>
            </a>
        </li>
        <li>
            <a href="/staff/report-centre" class="<?php echo $activePage === 'report-centre' ? 'active' : ''; ?>" title="Report Centre">
                <i class="fas fa-chart-line"></i> <span class="sidebar-nav-label">Report Centre</span>
            </a>
        </li>
        ...
        <li>
            <a href="/staff/leave-request" class="<?php echo $activePage === 'leave-request' ? 'active' : ''; ?>" title="Leave Request">

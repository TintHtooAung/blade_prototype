...
<div class="simple-section">
    <div class="simple-header">
        <div>
            <h3><i class="fas fa-file-invoice-dollar"></i> Additional Fees</h3>
            <p style="margin: 4px 0 0 0; font-size: 14px; color: #666;">
                One-time fees and event-based charges (e.g., registration, uniform, field trips, sports events)
            </p>
        </div>
        <div style="display: flex; gap: 12px;">
            <button class="simple-btn primary" onclick="openAddFeeDialog()">
        ...
        <table class="academic-table">
            ...
            <tbody id="additionalFeesTableBody">
                <tr>
                    ...
                    <td><span class="badge-type onetime">One-Time</span></td>
                    <td>$50.00</td>
                    <td>Aug 15, 2024</td>
                    <td>New student registration</td>
                    <td><span class="collection-status">85%</span></td>
                    <td class="actions-cell">
                        <button class="simple-btn-icon edit-btn" onclick="editAdditionalFee('ADF001')" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="simple-btn-icon delete-btn" onclick="deleteAdditionalFee('ADF001', this)" title="Delete">
                            <i class="fas fa-trash"></i>
                        </button>
                    </td>
                </tr>
                <tr>
                    <td><strong>Sports Day Fee</strong></td>
                    <td><span class="badge-type special">Special Event</span></td>
                    <td>$25.00</td>
                    <td>Dec 20, 2024</td>
                    <td>Annual sports day participation</td>
                    <td><span class="collection-status">92%</span></td>
                    <td class="actions-cell">
                        <button class="simple-btn-icon edit-btn" onclick="editAdditionalFee('ADF002')" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="simple-btn-icon delete-btn" onclick="deleteAdditionalFee('ADF002', this)" title="Delete">
                            <i class="fas fa-trash"></i>
                        </button>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>$30.00</td>
                    <td>Sep 1, 2024</td>
                    <td>Library access and resources</td>
                    <td><span class="collection-status">78%</span></td>
                    <td class="actions-cell">
                        <button class="simple-btn-icon edit-btn" onclick="editAdditionalFee('ADF003')" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="simple-btn-icon delete-btn" onclick="deleteAdditionalFee('ADF003', this)" title="Delete">
                            <i class="fas fa-trash"></i>
                        </button>
                    </td>
                </tr>
                <tr>
                    <td><strong>Field Trip Fee</strong></td>
                    <td><span class="badge-type special">Special Event</span></td>
                    <td>$75.00</td>
                    <td>Nov 15, 2024</td>
                    <td>Educational field trip to museum</td>
                    <td><span class="collection-status">65%</span></td>
                    <td class="actions-cell">
                        <button class="simple-btn-icon edit-btn" onclick="editAdditionalFee('ADF004')" title="Edit">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="simple-btn-icon delete-btn" onclick="deleteAdditionalFee('ADF004', this)" title="Delete">
                            <i class="fas fa-trash"></i>
                        </button>
                    </td>
                </tr>

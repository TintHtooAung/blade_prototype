...
document.addEventListener('DOMContentLoaded', function(){
    // Close Room Dialog function
    window.closeRoomDialog = function() {
    ...
    editRoomBtn.addEventListener('click', function() {
        ...
        document.getElementById('roomDialogTitle').textContent = 'Edit Room';
        document.getElementById('roomNumber').value = roomNumber;
        document.getElementById('roomBuilding').value = 'Building A'; // Get from actual data
        document.getElementById('roomFloor').value = '1st Floor'; // Get from actual data
        document.getElementById('roomCapacity').value = '35'; // Get from actual data
        document.getElementById('roomEquipment').value = 'Projector, Whiteboard'; // Get from actual data
        document.getElementById('roomAC').value = 'Available'; // Get from actual data
        document.getElementById('roomDialog').style.display = 'flex';
    });
    
    // Override saveRoom function for detail page
    window.saveRoom = function() {
        const newNumber = document.getElementById('roomNumber').value.trim();
        const newBuilding = document.getElementById('roomBuilding').value.trim();
        const newFloor = document.getElementById('roomFloor').value.trim();
        const newCapacity = document.getElementById('roomCapacity').value.trim();
        const newEquipment = document.getElementById('roomEquipment').value.trim();
        const newAC = document.getElementById('roomAC').value.trim();

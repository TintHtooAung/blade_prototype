...
<div class="simple-section">
    <div class="simple-header">
        ...
        <div class="section-actions">
            <button type="button" class="simple-btn secondary" onclick="window.location.href='/teacher/dashboard'">
        ...
        <div class="form-section">
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="employeeName" name="employeeName" class="form-input" value="Dr. Sarah Williams" readonly>
                </div>
            </div>
            ...
            <tbody>
                <tr data-submitted-date="2025-10-28">
                    ...
                    <td class="actions-cell">
                        <button class="action-icon view" title="View Details" onclick="viewLeaveRequest('LR-2025-0142')">
                ...
                <tr data-submitted-date="2025-09-10">
                    ...
                    <td>Sep 10, 2025</td>
                    <td class="actions-cell">
                        <button class="action-icon view" title="View Details" onclick="viewLeaveRequest('LR-2025-0128')">
                            <i class="fas fa-eye"></i>
                        </button>
                    </td>
                </tr>
                <tr data-submitted-date="2025-08-01">
                    ...
                    <td>Aug 01, 2025</td>
                    <td class="actions-cell">
                        <button class="action-icon view" title="View Details" onclick="viewLeaveRequest('LR-2025-0105')">
                            <i class="fas fa-eye"></i>
                        </button>
                    </td>
                </tr>
...
function resetForm() {
    ...
    document.getElementById('employeeName').value = 'Dr. Sarah Williams';

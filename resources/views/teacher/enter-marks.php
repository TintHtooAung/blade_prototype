...
<div class="simple-section">
    <div class="simple-header">
        <h3><i class="fas fa-edit"></i> Grade Entry</h3>
    ...
    <div class="content-placeholder">
        ...
        <h4>Enter Marks & Grades</h4>
        <p>Enter student marks, grades, and assessments for your classes and subjects.</p>

...
<div class="simple-section">
    <div class="simple-header">
        <h3><i class="fas fa-chart-line"></i> Report Centre</h3>
    ...
    <div class="content-placeholder">
        ...
        <h4>Report Centre</h4>
        <p>Generate and manage reports, analytics, and data insights for school operations.</p>

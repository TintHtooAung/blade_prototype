...
<div class="navigation-breadcrumb">
    <a href="/staff/student-profiles" class="breadcrumb-link">
...
<div class="simple-section">
    <div class="simple-header">
        ...
        <button class="simple-btn" onclick="window.location.href='/staff/student-profile-edit?id=<?php echo htmlspecialchars($id); ?>'">

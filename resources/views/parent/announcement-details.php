...
<div class="navigation-breadcrumb">
    <a href="/parent/announcements" class="breadcrumb-link">
    ...
    <div class="exam-details-header">
        <div class="exam-info-card">
            <div class="exam-title-section">
                <h3 id="announcementTitle">Parent-Teacher Meeting</h3>
                <span class="exam-id" id="announcementId">ANN001</span>
            </div>
            <div class="exam-badges" id="announcementBadges">
                <span class="badge tutorial-badge" id="announcementType">Academic</span>
                <span class="badge active-badge" id="announcementPriority">High</span>
            </div>
        </div>
    </div>
    ...
    <div class="exam-detail-card">
        ...
        <div class="exam-detail-content">
            <div class="detail-row">
                ...
                <span id="detailTitle">Parent-Teacher Meeting</span>
            </div>
            <div class="detail-row">
                <label>Type:</label>
                <span id="detailType">Academic</span>
            </div>
            <div class="detail-row">
                <label>Priority:</label>
                <span id="detailPriority">High</span>
            </div>
            <div class="detail-row">
                <label>Published Date:</label>
                <span id="detailDate">October 30, 2025</span>
            </div>
            <div class="detail-row">
                <label>Target Audience:</label>
                <span id="detailAudience">Parents</span>
            </div>
            <div class="detail-row">
                <label>Campuses:</label>
                <span id="detailCampuses">All</span>
            </div>
        </div>
    </div>
    ...
    <div class="exam-detail-card">
        ...
        <div class="exam-detail-content">
            <p id="announcementMessage" style="color: #666; line-height: 1.6; white-space: pre-wrap;">
                Meeting scheduled for November 5th, 2025. All parents are requested to attend.
            </p>
        </div>
    </div>
</div>
...
// Sample announcements data for parent portal
const sampleAnnouncements = {
    'ANN001': {
        id: 'ANN001',
        title: 'Parent-Teacher Meeting',
        message: 'Meeting scheduled for November 5th, 2025. All parents are requested to attend.',
        type: 'Academic',
        priority: 'High',
        date: '2025-10-30',
        audience: 'Parents',
    ...
    'ANN002': {
        ...
        message: 'Sports Day will be held on November 15th. Registration forms available in office.',
        type: 'Event',
        priority: 'Medium',
        date: '2025-10-28',
        audience: 'All Users',
    ...
    'ANN003': {
        ...
        message: 'Mid-term examination results are now available in the portal.',
        type: 'Academic',
        priority: 'High',
        date: '2025-10-25',
        audience: 'Parents',
    ...
    'ANN004': {
        ...
        message: 'School will remain closed on October 26th for National Holiday.',
        type: 'General',
        priority: 'Medium',
        date: '2025-10-22',
        audience: 'All Users',
    ...
    'ANN005': {
        ...
        message: 'Annual book fair from October 28-30 in the school library.',
        type: 'Event',
        priority: 'Low',
        date: '2025-10-20',
        audience: 'All Users',
    ...
    'ANN006': {
        ...
        message: 'Students are encouraged to participate in the upcoming science exhibition.',
        type: 'Academic',
        priority: 'Medium',
        date: '2025-10-18',
        audience: 'All Users',
...
function loadAnnouncementDetails() {
    // Try to get from localStorage first (shared with other portals)
